...
module Accessibility {
     ...
     * @experimental
     */
    export type AXValueType = 'boolean' | 'tristate' | 'booleanOrUndefined' | 'idref' | 'idrefList' | 'integer' | 'node' | 'nodeList' | 'number' | 'string' |
     ...
     * @experimental
     */
    export type AXWidgetAttributes = 'autocomplete' | 'haspopup' | 'level' | 'multiselectable' | 'orientation' | 'multiline' | 'readonly' | 'required' |
...
class Accessibility {
     ...
     * @experimental
     */
    public async getPartialAXTree(params: Accessibility.Params.getPartialAXTree): Promise<Accessibility.Result.getPartialAXTree>{
        return await new Promise<Accessibility.Result.getPartialAXTree>((resolve, reject) => {
            this.dbg.sendCommand('Accessibility.getPartialAXTree', params, (error: any, result: any) => {
                this.assertError(error, 'Accessibility.getPartialAXTree')
                resolve(result as Accessibility.Result.getPartialAXTree)
            })
        })
    }
